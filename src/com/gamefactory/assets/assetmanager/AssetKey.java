...
/**
 * La classe AssetKey repr√©sente une cl√© permettant d'identifier un asset.
 *
 * Elle est compos√©e de : - le type qui repr√©sente le dossier dans lequel se
 ...
 * acc√©der √† celui ci en cr√©eant un new AssetKey("images", "asset.png").
 *
...
public class AssetKey {
    ...
    /**
     * RÈcupËre le type (dossier) identifiant l'asset
     * @return
     */
    ...
    /**
     * RÈcupËre l'extension de l'asset
     * @return
     */
