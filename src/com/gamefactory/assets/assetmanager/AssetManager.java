 ...
 * liÃ©s Ã  la gestion des assets.
 *
 * Il contient (pour l'instant) un provider mais on pourrait peut Ãªtre en avoir
 * plusieurs de mÃªme pour le cache et une map de TypeLoaders.
 *
 * Il ne propose que Ã  l'utilisateur de charger un asset, une copie d'un asset
...
public class AssetManager {
    ...
    /**
     * Initialise le provider et la liste des loaders Ã  partir d'un fichier de
     * configuration.
     *
     * - Pascal Luttgens.
     */
