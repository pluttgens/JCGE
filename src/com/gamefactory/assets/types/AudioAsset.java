...
/**
 * La classe AudioAsset reprÃ©sente le stockage d'une resource audio.
 * 
...
public class AudioAsset extends Asset {
    ...
    /**
     * Récupère les données d'une ressource audio
     */
    ...
    /**
     * Récupère le format d'une ressource audio
     * @return
     */
    ...
    /**
     * Crée une copie de la ressource audio
     */
    @Override
    public Asset clone() {
